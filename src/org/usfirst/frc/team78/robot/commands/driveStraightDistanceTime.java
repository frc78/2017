 ...
 *
 */
public class driveStraightDistanceTime extends Command {

	
	public double desiredRots;
	public double milliseconds;
	Timer driveStraightTimer = new Timer();
	
    public driveStraightDistanceTime(double desiredFeet, double millis) {
...
//		}
    ...
    protected boolean isFinished() {
    	 return (Robot.chassis.isAtDistanceTarget(desiredRots) || driveStraightTimer.get() >= milliseconds);
