 ...
 *
 */
public class driveStraightCurrentStop extends Command {

	
	public double desiredRots;
	int i;
	
    public driveStraightCurrentStop(double desiredFeet) {
...
//		}
    ...
    protected void execute() {
    	...
    	if(Robot.chassis.getPortCurrent() >= 7 && i > 20){
    		
    		Robot.chassis.currentDrawPort = true;
    	}else{}
    	if(Robot.chassis.getStarboardCurrent() >= 7 && i > 20){
    		
    		Robot.chassis.currentDrawStarboard = true;
    	}else{}
    ...
    protected boolean isFinished() {
    	boolean bool = Robot.chassis.isAtDistanceTarget(desiredRots) 
    			|| (Robot.chassis.currentDrawPort 
    			||	Robot.chassis.currentDrawStarboard);
    	return bool;
    }
